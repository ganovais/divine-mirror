  ...
  return (
    ...
    >
      <Select value={selectedModel} onValueChange={onModelChange}>
        <SelectTrigger className="min-h-[40px] sm:min-h-[60px] bg-white border-1 border-gray-200 rounded-xl hover:border-[#8e0000]/40 transition-all duration-200 focus:ring-1 focus:ring-[#8e0000]/30 focus:border-[#8e0000]">
